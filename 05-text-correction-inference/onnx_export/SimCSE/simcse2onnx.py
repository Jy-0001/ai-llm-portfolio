...
class OnnxTrans():
    ...
    def init_model(self,):
        ...
        self.model.load_state_dict(torch.load('./output/sup_model.pt', map_location='cpu'), strict=True)
        self.model.eval()
    ...
    def init_onnx(self,):
        ...
        # 明确模型的输入, 输出, 动态轴的设置
        dynamic_axes = {'input_ids': [1], 'attention_mask': [1], 'token_type_ids':[1], 'output': [1]}
