...
class Config(object):
    def __init__(self, dataset):
        ...
        self.class_list = [x.strip() for x in open(self.data_path + 'bert_classification.txt').readlines()]
        self.save_path = './bert_saved_dict'
        self.save_path2 = './bert_saved_dict_quantized'
...
if __name__ == '__main__': #主函数
    ...
    #调用:所在目录终端输入：python bert.py --model bert