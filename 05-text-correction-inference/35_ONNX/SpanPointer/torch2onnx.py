...
class OnnxTrans():
    ...
    def init_ner_model(self,):
        ...
        opt = Args().get_parser()
        self.tokenizer = BertTokenizer.from_pretrained('./src/bert-base-chinese')
        ...
        self.ner_model.load_state_dict(torch.load('./out/best_model.pt', map_location='cpu'), strict=True)
    ...
    def init_onnx(self,):
        ...
        out = torch.onnx.export(self.ner_model, 
                                onnx_input, 
