...
class Args:
    ...
    def initialize(parser: argparse.ArgumentParser):
        parser.add_argument('--bert_dir', default='../macbert_chinese_base/', help='the dir of bert weights')
        ...
        parser.add_argument('--train_data', default='../raw_data/train.json', help='train data for model')
        parser.add_argument('--valid_data', default='../raw_data/dev.json', help='valid data for model')
        parser.add_argument('--test_data', default='../raw_data/dev.json', help='test data for model')
