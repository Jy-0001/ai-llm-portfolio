...
# l2i_dic = {'O': 0, u'B-sym': 1, u'B-dis': 2, u'I-sym': 3, u'I-dis': 4, u'E-sym': 5, u'E-dis': 6, '<pad>': 7} #sym代表symptoms症状，dis代表disease病名

# i2l_dic = {0: 'O', 1: u'B-sym', 2: u'B-dis', 3: u'I-sym', 4: u'I-dis', 5: u'E-sym', 6: u'E-dis', 7: '<pad>'}
...
lr = 0.8e-3 # 因为没有用预训练模型，学习率采用千分之一
