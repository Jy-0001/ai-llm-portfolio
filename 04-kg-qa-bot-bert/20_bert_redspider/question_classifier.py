...
class QuestionClassifier:
    ...
    def classify(self, question):
        ...
        if self.question_class(question) == 2 and ('disease' in types):
            question_type = 'disease_symptom'
            question_types.append(question_type)

        if self.question_class(question) == 1 and ('disease' in types):
            question_type = 'disease_food'
            question_types.append(question_type)

        if self.question_class(question) == 0 and ('disease' in types):
            question_type = 'disease_drug'
            question_types.append(question_type)

        if self.question_class(question) == 3 and ('disease' in types):
