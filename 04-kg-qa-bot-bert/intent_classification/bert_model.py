...
class Config(object):
    def __init__(self, dataset):
        ...
        self.train_path = self.data_path + 'bert_model_train.txt' #训练集
        self.dev_path = self.data_path + 'bert_model_dev.txt' #验证集
        self.test_path = self.data_path + 'bert_model_test.txt' #测试集
        self.class_list = [x.strip() for x in open(self.data_path + 'bert_model_classification.txt').readlines()]
        self.save_path = './bert_model_saved_dict'
