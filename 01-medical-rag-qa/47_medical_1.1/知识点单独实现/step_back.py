...
# 定义生成"后退一步"问题的Prompt和链
step_back_prompt_template = ChatPromptTemplate.from_messages([
    ("user", "你是一位善于提炼核心问题的专家。请将以下可能很具体的问题,"
             "抽象成一个更通用,更高层次的“后退一步”的问题。\n"
...
step_back_qustion = step_back_chain.invoke(user_query)
print('-'*50)
print('step_back_qustion:', step_back_qustion)
print('-'*50)
